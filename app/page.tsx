...
const moneyFormatter = new Intl.NumberFormat("en-IN", { minimumFractionDigits: 0, maximumFractionDigits: 2 });
const money = (value: number) => `${value < 0 ? "−" : ""}₹${moneyFormatter.format(Math.abs(value))}`;
